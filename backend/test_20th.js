...
async function run() {
    ...
    console.log("Running getPredictedFixturesGroupedByLeague for 2026-07-20...");
    const result = await getPredictedFixturesGroupedByLeague("2026-07-20");
    console.log(`Result length: ${result.length}`);
    
    const count = await Fixture.countDocuments({
        'fixture.fixture.date': {
          $gte: '2026-07-20T00:00:00+03:00',
          $lte: '2026-07-20T23:59:59.999+03:00'
        },
