...
export default function Footer() {
  return (
    <footer className="bg-gray-100 text-gray-600 text-[11px] font-semibold md:justify-center px-1 pt-1 pb-3 md:pt-2 md:pb-4 border-t border-gray-200">
      {/* Main section */}
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4 md:text-center">
        ...
        {/* Brand */}
        <div>
          <h5 className="text-[11px] font-semibold text-gray-800 tracking-wider">Bookiesmasters</h5>
          <p className="text-[11px] leading-snug text-gray-600 text-justify">
        ...
        {/* Contact + Socials */}
        <div>
          <h5 className="text-[11px] font-semibold text-gray-800 tracking-wider">Stay connected</h5>
        ...
        {/* Quick Links */}
        <div>
          <h5 className="text-[11px] font-semibold text-gray-800 tracking-wider">Quick links</h5>
          <ul className="text-[11px] space-y-0.5">
            <li>
              <Link href="/fixtures" className="hover:text-teal-400 transition-colors">
                All Fixtures
              </Link>
            </li>
            <li>
        ...
        <div className="space-y-1.5">
          <h5 className="text-sm font-semibold text-gray-800 tracking-wider">Betting sites</h5>
