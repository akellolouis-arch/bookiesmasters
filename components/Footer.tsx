...
export default function Footer() {
  return (
    <footer className="bg-gray-800 text-gray-400 text-[11px] font-semibold md:justify-center px-1 pt-1 pb-3 md:pt-2 md:pb-4 border-t border-white/10">
      {/* Main section */}
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4 md:text-center">
        ...
        {/* Brand */}
        <div>
          <h5 className="text-[11px] font-semibold text-gray-200 tracking-wider">Bookiesmasters</h5>
        ...
        {/* Contact + Socials */}
        <div>
          <h5 className="text-[11px] font-semibold text-gray-200 tracking-wider">Stay connected</h5>
        ...
        {/* Quick Links */}
        <div>
          <h5 className="text-[11px] font-semibold text-gray-200 tracking-wider">Quick links</h5>
        ...
        <div className="space-y-1.5">
          <h5 className="text-sm font-semibold text-gray-200 tracking-wider">Betting sites</h5>
      ...
      {/* Footer bottom */}
      <div className="text-center text-gray-400 text-[11px] mt-2 tracking-widest">
