                    ...
                    <div key={teamName} className="w-full">
                        <div className="flex flex-col items-start mb-2 border-b border-white/10 pb-1">
                            <div className="flex items-center justify-start gap-2">
                                ...
                                <h4 className="text-xs font-bold text-emerald-200/70 tracking-wide capitalize truncate">{teamName}</h4>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2 sm:space-y-3 mt-2">
                            {teamInjuries.map((injury, idx) => (
                                <div key={idx} className="flex items-center gap-2 sm:gap-3">
                                    <span className="text-[10px] sm:text-[11px] text-gray-500 font-bold w-3 sm:w-4 text-right shrink-0">{idx + 1}.</span>
                                    <img
