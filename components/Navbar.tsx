      ...
      */}
      <div className="max-w-7xl mx-auto px-2 py-0 md:px-8 flex h-[60px] items-center gap-2">
        ...
        <div className="hidden shrink-0 items-center space-x-8 md:flex">
          ...
          <Link
            href="/vip"
            className="px-4 py-1.5 bg-transparent border border-[#63FF79]/30 text-[#63FF79] font-bold rounded-full text-xs hover:scale-105 transition-transform shadow-[0_0_10px_rgba(99,255,121,0.15)]"
          >
            GO PRO
          </Link>
        </div>
        ...
        <Link
          href="/vip"
          className="flex md:hidden items-center justify-center shrink-0 px-3 py-1 bg-transparent border border-[#63FF79]/30 text-[#63FF79] font-bold tracking-wide rounded-full text-[10px] shadow-[0_0_8px_rgba(99,255,121,0.15)]"
        >
          GO PRO
        </Link>
      </div>
