    ...
    return (
        <div className="w-full md:max-w-2xl lg:max-w-2xl mx-auto px-1 sm:px-4 md:px-4 pt-2 pb-4 font-sans text-gray-700">
            <div className="space-y-3">
                ...
                <p className="text-[11px] sm:text-xs leading-normal text-gray-600">Welcome to <strong className="text-gray-900">Bookiesmasters</strong>, your ultimate destination for data-driven football insights.</p>
