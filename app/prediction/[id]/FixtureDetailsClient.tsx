...
const FixtureDetailsClient: React.FC<FixtureDetailsClientProps> = ({ data: initialData }) => {
    ...
    return (
        <div className="text-white py-4 px-2 sm:px-4">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col gap-2 my-2">
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2">Prematch Odds</h3>
                    ...
                    {data.apiPrediction?.advice && (
                        <div className="flex flex-col items-center justify-center text-center mt-2">
                            <h3 className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest flex items-center justify-center gap-2 mb-2">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                        ...
                        {displayEvents && displayEvents.length > 0 && (
                            <div className="lg:col-span-7 space-y-4">
                                <div>
                                    <h3 className="text-sm font-bold text-gray-200 lowercase tracking-widest flex items-center justify-center gap-2">
