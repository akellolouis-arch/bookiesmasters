export default function TermsPage() {
    return (
        <div className="w-full md:max-w-2xl lg:max-w-2xl mx-auto px-1 sm:px-4 md:px-4 py-4 font-sans text-gray-300">
            <div className="space-y-3">
                ...
                <h2 className="text-xs font-semibold text-white mt-3">1. Acceptance of Terms</h2>
                ...
                <h2 className="text-xs font-semibold text-white mt-3">2. Use of Data</h2>
                <p className="text-xs leading-normal text-gray-400">
                ...
                <h2 className="text-xs font-semibold text-white mt-3">3. Intellectual Property</h2>
                <p className="text-xs leading-normal text-gray-400">
